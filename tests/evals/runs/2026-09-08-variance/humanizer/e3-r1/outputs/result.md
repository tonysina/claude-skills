...
Notes: Removed Gemini citation markers ([cite: N]) and span markers ([span_2]) which were residue from AI generation. Prose is factual and suitable for company history once markup is stripped.
