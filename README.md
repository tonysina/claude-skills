...
Skills extend Claude with specialized behaviors invoked via slash commands (e.g. `/humanizer`, `/split-pdf`). Each skill is self-contained and works across Claude Code and claude.ai.
...
|-------|-------------|----------|
| [and-or-planner](skills/and-or-planner/) | Autonomous AND/OR task planner — breaks complex tasks into conjunctive and alternative subtasks before execution | [.skill](dist/and-or-planner.skill) |
...
| [markdown-fetch](skills/markdown-fetch/) | Fetches web content as clean markdown, reducing token usage by up to 80% | [.skill](dist/markdown-fetch.skill) |
